...
- **Control:** If you are in the EEA, the UK, or Switzerland, you will be asked for your advertising preferences before ads are shown, and can change that choice at any time from Settings. Purchasing AuroraTracker Pro removes ads entirely. You can also reset or delete your advertising ID in your device's privacy settings.
...
- **Withdraw consent:** Revoke location or notification permissions in device settings at any time. Advertising preferences can be changed under Settings → Privacy → Ad Privacy Options.
- **Object to ads:** Purchase Pro to remove advertising entirely, or reset your advertising ID.
...
The free version of AuroraTracker displays ads supplied by Google AdMob. Ads are how the free version is funded, and they cannot be switched off within it.

If you are located in the European Economic Area, the United Kingdom, or Switzerland, you will be shown a consent form before any personalised advertising is enabled. You may decline personalised ads and continue using the app exactly as before — you will simply see non-personalised ads instead. You can revisit and change this choice at any time under **Settings → Privacy → Ad Privacy Options**.

You can also limit ad personalisation by resetting or deleting your advertising identifier in your device's privacy settings.
